...
#>
function Export-AzVizFile {
    [CmdletBinding()]
    param (
        # # Names of target resource groups 
        # [Parameter(ParameterSetName = 'AzLogin', Position = 0)]
        # [string[]] $ResourceGroup,

        # File paths to target ARM templates
        [Parameter(ParameterSetName = 'FilePath', Position = 0)]
        [string] $Path,
...
Export-ModuleMember Export-AzVizFile